...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'nis' => [
            'unique' => 'NIS ini sudah terdaftar dalam sistem.',
            'required' => 'NIS wajib diisi.',
            'regex' => 'Format NIS tidak valid.',
        ],
        'nisn' => [
            'unique' => 'NISN ini sudah terdaftar dalam sistem.',
        ],
        'nama_lengkap' => [
        ...
        'jenis_kelamin' => [
            ...
            'in' => 'Jenis kelamin harus Laki-laki (L) atau Perempuan (P).',
        ],
        'tanggal_lahir' => [
        ...
        'email' => [
            ...
            'unique' => 'Email ini sudah terdaftar dalam sistem.',
        ],
        'password' => [
