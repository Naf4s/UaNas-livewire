<div>
    <div class="container mx-auto py-8">
        <h2 class="text-2xl font-semibold mb-6">Manajemen Kurikulum</h2>
        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full lg:w-1/3 px-4 mb-6 lg:mb-0">
                <div class="bg-white shadow-md rounded-lg p-6">
                    <h3 class="text-xl font-semibold mb-4">Template Kurikulum</h3>

                    {{-- Pencarian dan Filter --}}
                    <div class="mb-4">
                        <input type="text" wire:model.live="searchTemplate" placeholder="Cari template..." class="form-input w-full rounded-md shadow-sm">
                    </div>
                    <div class="flex space-x-4 mb-4">
                        <select wire:model.live="jenisKurikulumFilter" class="form-select rounded-md shadow-sm">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($templates as $template)
                                    <tr wire:key="template-{{ $template->id }}" class="{{ $selectedTemplateId == $template->id ? 'bg-blue-50' : '' }}">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">
                                                <button wire:click="selectTemplate({{ $template->id }})" class="text-indigo-600 hover:text-indigo-900 focus:outline-none">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            @if($template->status === 'nonaktif')
                                                 <button wire:click="activateTemplate({{ $template->id }})" class="text-green-600 hover:text-green-900 mr-2">Aktifkan</button>
                                            @else
                    ...
                    {{-- Tombol Tambah Template (Opsional, bisa diimplementasikan nanti jika diperlukan form terpisah) --}}
                    {{-- <button wire:click="showCreateTemplateModal" class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md shadow hover:bg-blue-700">Tambah Template Baru</button> --}}
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    <h3 class="text-xl font-semibold mb-4">Aspek Penilaian
                     ...
                     @if($selectedTemplate)
                        ...
                        <div class="mb-4">
                            <button wire:click="showAddAspekModal()" class="px-4 py-2 bg-green-600 text-white rounded-md shadow hover:bg-green-700">Tambah Aspek Baru (Root)</button>
                        </div>
                     ...
                     @else
                         <p class="text-gray-500 text-center">Silakan pilih template kurikulum dari daftar di samping.</p>
                     @endif
                </div>
            </div>
        </div>
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                ...
                <form wire:submit.prevent="saveAspect">
                    <div class="mb-4">
                        ...
                        <input type="text" id="nama_aspek" wire:model="nama_aspek" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="tipe" wire:model="tipe" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                     ...
                     @if (!$isEditingAspek || ($isEditingAspek && $editingAspek?->parent_id))
                         <div class="mb-4">
                             ...
                             <select id="parent_id" wire:model="parent_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                     ...
                     <div class="mb-4">
                        ...
                        <input type="number" id="urutan" wire:model="urutan" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                     ...
                     <div class="mb-4">
                        ...
                        <input type="number" step="0.01" id="bobot" wire:model="bobot" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    ...
                    <div class="mb-4">
                        <label for="catatan" class="block text-sm font-medium text-gray-700">Catatan (Opsional)</label>
                         <textarea id="catatan" wire:model="catatan" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
    ...
    {{-- Blade partial for rendering individual aspect items in the tree --}}
    {{-- This file needs to be created: resources/views/livewire/curriculum-management/aspek-item.blade.php --}}
